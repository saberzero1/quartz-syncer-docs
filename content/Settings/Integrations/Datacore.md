---
{"publish":true,"title":"Datacore","description":"Whether to enable support for the Datacore plugin. Requires Datacore to be installed and enabled.","created":"2025-06-09T20:48:56Z+0200","modified":"2025-07-23T16:43:44Z+0200","tags":["datacore","integration","settings/integrations"],"cssclasses":""}
---
...
<div class="carousel-container"><div class="carousel" mask="true"><article><img src="" /><h2>Dataview</h2><div><p>Whether to enable support for the Dataview plugin. Requires Dataview to be installed and enabled.</p><a href="/Settings/Integrations/Dataview.md" target="_blank" rel="noopener nofollow">Link</a></div></article><article><img src="" /><h2>Fantasy Statblocks</h2><div><p>Whether to enable support for the Fantasy Statblocks plugin. Requires Fantasy Statblocks to be installed and enabled.</p><a href="/Settings/Integrations/Fantasy Statblocks.md" target="_blank" rel="noopener nofollow">Link</a></div></article><article><img src="" /><h2>Excalidraw</h2><div><p>Whether to enable support for the Excalidraw plugin. Feature is currently disabled.</p><a href="/Settings/Integrations/Excalidraw.md" target="_blank" rel="noopener nofollow">Link</a></div></article><article><img src="" /><h2>Auto Card Link</h2><div><p>Whether to enable support for the Auto Card Link plugin. Requires Auto Card Link to be installed and enabled.</p><a href="/Settings/Integrations/Auto Card Link.md" target="_blank" rel="noopener nofollow">Link</a></div></article><article><img src="" /><h2>Datacore</h2><div><p>Whether to enable support for the Datacore plugin. Requires Datacore to be installed and enabled.</p><a href="/Settings/Integrations/Datacore.md" target="_blank" rel="noopener nofollow">Link</a></div></article></div><style>  
    .carousel-container {
      place-items: center;
      display: flex;
    }
