---
{"publish":true,"title":"Fantasy Statblock","description":"Whether to enable support for the Fantasy Statblock plugin. Requires Fantasy Statblock to be installed and enabled.","created":"2025-06-18T14:06:35Z+0200","modified":"2025-06-18T17:45:57Z+0200","tags":["integration","settings/integrations","ttrpg"],"cssclasses":""}
---
...
.statblock-plugin-parent .statblock-detached {
	position: absolute;
	top: -9999px;
	/* top: 20px;
    left: 50%;
...
.statblock-plugin-parent .statblock-item-container {
	margin-bottom: 0.25rem;
}

.statblock-plugin-parent .statblock-item-inline {
	display: flex;
...
/**
    ...
    */
.statblock-plugin-parent .statblock {
	...
	--active-image-border-color: var(--statblock-image-border-color,
	...
	--active-font-color: var(--statblock-font-color,
			--active-primary-color);
...
.statblock-plugin-parent .container {
	display: flex;
	position: relative;
	width: 100%;
	margin: 0.25rem 0;
...
.statblock-plugin-parent .icons {
	position: absolute;
	left: var(--size-2-2);
}

/* Bar */
.statblock-plugin-parent .bar {
	height: 5px;
...
/* Collapse */
.statblock-plugin-parent details>summary {
	outline: none;
...
.statblock-plugin-parent details>summary::-webkit-details-marker,
.statblock-plugin-parent details>summary::marker {
	display: none !important;
}

.statblock-plugin-parent details>summary>.collapser {
	position: absolute;
	top: 50%;
	right: 8px;
...
.statblock-plugin-parent details>summary>.collapser>.handle {
...
.statblock-plugin-parent details[open]>summary>.collapser>.handle {
	transform: rotate(90deg);
}

/* Content */
.statblock-plugin-parent .statblock-content {
	...
	box-shadow: var(--active-box-shadow-x-offset) var(--active-box-shadow-y-offset) var(--active-box-shadow-blur) var(--active-box-shadow-color);
	margin-left: 2px;
	margin-right: 2px;
	display: flex;
	gap: 1rem;
...
/* Heading */
.statblock-plugin-parent .flex-container {
	display: flex;
	justify-content: space-between;
	align-items: center;
}

.statblock-plugin-parent .heading {
...
/* Image */
.statblock-plugin-parent .image {
	width: var(--active-image-width);
	height: var(--active-image-height);
}

.statblock-plugin-parent .image.pointer {
	cursor: pointer;
}

.statblock-plugin-parent img {
	object-fit: cover;
	width: 100%;
	height: 100%;
	border-radius: 100%;
...
/* MarkdownHolder */
.statblock-plugin-parent .statblock-markdown {
	display: inline;
}
...
.statblock-plugin-parent .property-name {
	margin: 0;
	margin-right: 0.25em;
	display: inline;
...
/* Rule */
.statblock-plugin-parent .tapered-rule {
	width: auto;
	margin: 0.5em 0;
	height: 5px;
...
.statblock-plugin-parent .property-text {
	display: inline;
	margin: 0;
}

.statblock-plugin-parent .save-entry,
.statblock-plugin-parent .save-name,
.statblock-plugin-parent .save-value {
	display: inline;
}

.statblock-plugin-parent .save-entry:not(:last-child) .save-value::after {
	content: ", ";
}

/* SectionHeading */
.statblock-plugin-parent .section-header {
...
.statblock-plugin-parent ul.spell-item.first {
	margin-top: revert;
}

.statblock-plugin-parent ul.spell-item.last {
	margin-bottom: revert;
}

.statblock-plugin-parent .spells {
	font-style: italic;
}

/* Subheading */
.statblock-plugin-parent .subheading {
...
/* Table */
.statblock-plugin-parent .statblock-table-header {
	font-weight: var(--active-table-header-font-weight);
}

.statblock-plugin-parent .statblock-table {
	display: flex;
...
.statblock-plugin-parent .table-item {
	display: flex;
...
.statblock-plugin-parent .trait-name {
