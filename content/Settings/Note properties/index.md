...
| ------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- |
| [[Settings/Note properties/Created timestamp keys.md\|Created timestamp keys]]             | Comma-separated list of keys to look for to determine the created timestamp.                                                        | created, created\_at, date                 |
